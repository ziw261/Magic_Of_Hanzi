...
public class GameMenu : MonoBehaviour {
    ...
    public Text statusName, statusHP, statusMP, statusStr, statusDef, statusWpnEqpb, statusWpnPwr, statusArmrEqpb, statusArmrPwr, statusExp;
    ...
    public void StatusChar(int selected) {
        ...
        if (playerStats[selected].equippedArmr != "") {
            statusArmrEqpb.text = playerStats[selected].equippedArmr;
        }
